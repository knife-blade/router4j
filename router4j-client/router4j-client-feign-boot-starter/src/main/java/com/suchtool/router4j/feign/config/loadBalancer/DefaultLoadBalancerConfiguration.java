package com.suchtool.router4j.feign.config.loadBalancer;

import com.suchtool.router4j.feign.config.loadBalancer.router4j.Router4jLoadBalancerConfiguration;
