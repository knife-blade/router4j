// package com.knife.router4j.feign.config.byClient.concret;
//
// import feign.Client;
...
//  *      LoadBalancer配置：HttpClientFeignLoadBalancerConfiguration
//  */
// @Configuration(proxyBeanMethods = false)
// @ConditionalOnProperty("feign.httpclient.enabled")
// public class Router4jApacheHttpClientConfiguration {
//     /**
//      * 重要的类：
//      *      Feign自动配置：{@link FeignAutoConfiguration}
...
//      *           此构造函数被调用的地方：HttpClientFeignLoadBalancerConfiguration#feignClient(xxx)
