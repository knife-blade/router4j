// package com.knife.router4j.feign.config.byClient.client;
//
...
//
// /**
//  * Router4j提供的基于ApacheHttpClient的客户端
//  *   对此类的进行了修改：{@link OkHttpClient}
//  *   修改的方法是：{@link Router4jApacheHttpClient#execute(feign.Request, feign.Request.Options)}
//  */
// public class Router4jApacheHttpClient implements Client {
...
//     }
//
//     public Router4jApacheHttpClient(HttpClient client) {
//         this.client = client;
//     }
//
//     @Override
