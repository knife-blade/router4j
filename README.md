...
在“规则管理”中配置路径与实例的绑定：
![配置网关路径的路由](doc/2-4-1.png)

**2.配置feign路径的路由**
![配置feign路径的路由](doc/2-4-2.png)
...
![请求接口测试-1](doc/2-4-3-1.png)

storage：（全部都请求到了指定的实例192.168.150.1:9021）
![请求接口测试-1](doc/2-4-3-2.png)

# 三、使用详解

## 3.1 规则管理
底层是基于Spring自身的AntPathMatcher来实现的。
